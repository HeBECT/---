...
### Уникальные возможности Desktop-версии (v3.0)
...
### Уникальные возможности Web-версии (v1.0)

- 🌐 **Работает в браузере** - не требует установки
- 📱 **Кроссплатформенность** - работает на любом устройстве
- 🚀 **Быстрый запуск** - просто откройте HTML файл
- 📦 **Малый размер** - всего ~76 КБ
- 🏙️ **22 предустановленных города** - готовые локации из игры
...
### 🌐 Web-версия (HTML/CSS/JS) - v1.0

**Расположение:** `kenshi-trade-map-web/`

**Особенности:**
- Работает в любом браузере
- Не требует установки
- 22 предустановленных города
- Базовая и итоговая цены товаров
- Адаптивный дизайн
- Легко делиться
...
1. Скачайте папку `kenshi-trade-map-web/`
...
3. Кликайте по городам для построения пути
4. Нажмите `Enter` для завершения
5. Введите название и настройте товары
6. Нажмите `✓ Создать`
...
```
[Здесь будет скриншот веб-версии]
```
...
### Web-версия (JavaScript)

- **HTML5 Canvas** - отрисовка карты
- **Vanilla JavaScript (ES6+)** - без фреймворков
- **CSS3** - Grid, Flexbox, Animations
- **LocalStorage** - опциональное сохранение

**Архитектура:**
- Класс `KenshiTradeMap` - главный контроллер
- ~600 строк чистого JavaScript
- Модульная структура
- Event-driven подход

## 📊 Сравнение версий

| Функция | Web v1.0 | Desktop v3.0 |
|---------|----------|--------------|
| **Установка** | ⭐⭐⭐⭐⭐ Просто открыть | ⭐⭐⭐ Требует компиляции |
| **Производительность** | ⭐⭐⭐ Хорошая | ⭐⭐⭐⭐⭐ Отличная |
| **Размер** | ⭐⭐⭐⭐⭐ ~76 КБ | ⭐⭐⭐ ~5.7 МБ |
| **Предустановленные города** | ✅ 22 города | ❌ Создавайте сами |
| **Создание городов** | ❌ | ✅ Неограниченно |
| **Точек в маршруте** | Много | 2 (начало → конец) |
| **Маршрутов от города** | 1 | ∞ Неограниченно |
| **Выбор цвета** | ❌ Автоматически | ✅ Color picker |
| **Стрелки направления** | ❌ | ✅ |
| **Темная тема** | ❌ | ✅ |
| **Плавное приближение** | ❌ | ✅ |
| **Базовая цена товара** | ✅ | ❌ Только наценка |
| **Итоговая цена** | ✅ Автоматически | ❌ |
| **Кроссплатформенность** | ⭐⭐⭐⭐⭐ Везде | ⭐⭐⭐⭐ Win/Linux/Mac |
...
│
├── kenshi-trade-map-web/       # Web-версия (HTML/CSS/JS)
...
- Или запустите локальный сервер (см. раздел Установка)
...
- **GitHub Issues:** [Создать issue](https://github.com/yourusername/kenshi-trade-map/issues)
- **Discussions:** [Обсуждения](https://github.com/yourusername/kenshi-trade-map/discussions)
